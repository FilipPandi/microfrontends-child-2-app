...
export const SharedContext = createContext({data: "Neki tekst!"});
    ...
    return (
        <React.Fragment>
            <Panel style={{margin: '4%'}} header="Ovo je CMS dio" className="custom-panel">
                ...
                <h2><Link className={"link"} to="/com1"><Button severity="secondary" icon="pi pi-desktop"
                                                                label={"Component 1 - Routing"}/></Link></h2>
